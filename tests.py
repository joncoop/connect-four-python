...
def do_tests():
    ...
    print('Place disc')
    functions.place_disc(board, 2, 5, 1)
    print_2d_array(board)
    print()

    functions.place_disc(board, 1, 4, 1)
    functions.place_disc(board, 2, 3, 1)
    functions.place_disc(board, 1, 2, 1)
    functions.place_disc(board, 2, 5, 2)
    functions.place_disc(board, 1, 4, 2)
    functions.place_disc(board, 2, 3, 2)
    functions.place_disc(board, 1, 2, 2)
    functions.place_disc(board, 2, 1, 2)
    functions.place_disc(board, 1, 0, 2)
    print_2d_array(board)
    print()
